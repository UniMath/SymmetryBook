...
\begin{definition}\label{def:flagged-cat}
  ...
  and a function $f : A \to \Ob(\mathcal C)$.\footnote{%
    The terminology is a bit whimsical:
    it's meant to indicate that we have a ``fat'' object, a category $\mathcal C$,
    equipped with a ``thinner'' object, a (higher) groupoid $A$,
  glued together by the function $f$.}
\end{definition}
