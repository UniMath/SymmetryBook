...
\begin{theorem}\label{thm:1types-are-groupoids}
  ...
  $[A,B]$ to the function type $(A\to B)$ is an equivalence.
...
\end{theorem}
\begin{proof}
  Let's write out the definition of type of functors
  ...
  it remains to show it is surjective. Observe that for a groupoid $\mathcal A$
  with type of objects $A \defeq \Ob(\mathcal A)$, the hom-sets and the identity arrows
