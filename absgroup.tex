...
\begin{proof}
  ...
  \begin{align*}
    \Bconcr(\abstr(f))(q_G(z))
    &\jdeq \absprtor[\abstr(H)] \times_{\abstr(H)} \princ G(z) \\
    &\jdeq (\sh_H \eqto \sh_H) \times_{\abstr(H)} (\sh_G \eqto z)
  \end{align*}
  and
  \[
  ...
  \[
    c_z : (\sh_H \eqto \sh_H) \times_{\abstr(H)} (\sh_G \eqto z)
