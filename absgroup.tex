...
to infinite groups indicated in \cref{ch:actions}.}
...
\begin{remark}\label{rem:inverses-as-property}
  ...
  -- its proof goes by using the properties \ref{monoid:unit-laws} and \ref{monoid:ass-law} to prove that inverses are unique.  As a consequence,
...
\begin{remark}\label{rem:ee=e_coherence}
  Without the requirement that the underlying type of an abstract group or monoid is a set, life would be more complicated.  For instance, for the
