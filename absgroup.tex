...
\wip{What about $\varphi_*X$? Must be known. Looking at $f_*X(w)$,
which is a type of invariant maps, with underunderlying set
$(\Bf(\sh_G)\eqto\sh_H) \to X(\sh_G)$, my best guess is the subset of 
fixed elements of $T\to X$, with homomorphism sending $h:T$ to the
permutation of $T\to X$ sending $\alpha$ to $\alpha\circ(h\blank)$.}
