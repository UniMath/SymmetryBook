...
$$\absGSet\defequi \sum_{\mathcal X:\Set}\Hom_{\abstr}({\agp G},\abstr(\Sigma_{\mathcal X})).$$
...
$$\typeabstor{\agp G}\defequi\sum_{S:\Set_{\agp G}^{\abstr}}\Trunc{\absprtor{\agp G} \eqto S}.$$
\end{definition}
\begin{example}
...
\begin{lemma}
  ...
  $$\ev_{\shape_G}:\GSet\to\Set^{\abstr}_{\abstr(G)},\qquad \ev_{\shape_G}(X)\defequi(X(\shape_G),a_X)
$$
