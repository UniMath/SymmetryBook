...
\subsection{The action functors in the case of abstract groups}
...
up is: what are the abstract versions of the action functors $f^*$ and $f_!$ 
defined for concrete groups in \cref{def:restrictandinduce}?\footnote{%
See also \cref{ex:action-functors} and \cref{ex:Sigma-Pi-adj}
...
fixed elements of $T\to S$, with homomorphism sending $h:T$ to the
permutation of $T\to S$ sending $\alpha$ to $\alpha\circ(h\blank)$.}
...
Recall from \cref{sec:phi-functors} the action functors $\varphi^*$ 
and $\varphi_!$ for a given abstract homomorphism $\varphi$.
Let $G$ and $H$ be groups and let $f:\Hom(G,H)$ be a homomorphism.
Also recall the action functors $f^*$ and $f_!$ from
\cref{def:restrictandinduce}. 
