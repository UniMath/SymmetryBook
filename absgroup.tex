...
There we defined, for all $X:\BG\to\Set$, $f:\BG\to\BH$ and $w:\BH$,
$f_*X(w)\defeq
...
completely determined (cf.\ \cref{cor:orbit-equiv}) at $z\jdeq \sh_G$
...
\MB{Rather:  $(z\mapsto \preinv_z(g))$, or $\preinv_\blank(g)$}}
