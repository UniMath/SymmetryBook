...
that by the time you're reached the end you'll have a clean idea of
what ``symmetry'' means.
...
It feels reasonable to consider the rotations by $0^\circ$, $90^\circ$, $180^\circ$ and $270^\circ$ to be all the (rotational) symmetries of $\square$.  Two thoughts may strike you:
\begin{enumerate}
\item
