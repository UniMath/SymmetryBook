...
\emph{type-theoretic Yoneda lemma},\footnote{This is not just an analogy: using
  \cref{thm:1types-are-groupoids} and \cref{thm:yoneda-lemma}, we obtain the same
  result.} and the proof is \cref{xca:TTYoneda}.\footnote{%
...
Note that the set $f_!X(w)$ can also be identified as the orbit set of
