...
The purpose to this remark is to explain how
...
in \cref{sec:higher-images} the higher images. In these
...
consider $f^*Y \jdeq Y\circ f$.\footnote{We can use $f^*$ as is,
since every proposition is a set.} Then $f^*Y$ is subtype of $A$ 
