...
from $\USymG_x$ to $\USymG_y$, for every $y:X(\sh_G)$. This formulation
is sometimes more convenient, \eg in the proof of \cref{lem:burnside}.}
\end{implementation}
...
\section{The orbit-stabilizer theorem \MB{obsolete now?}}
...
\begin{proof}
 ...
 \footnote{%
  ...
  Applying \cref{con:lagrange}, in particular \cref{ft:lagrange-conj},
