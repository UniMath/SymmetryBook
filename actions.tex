...
%    see also \cref{rem:equivalents-of-[x]=[y]}.
  ...
  \[
    \sum_{s:S}\prod_{u:X_{hG}}\bigl( ([u]_0 = O) \to (f(u)=s) \bigr), 
  \]
  which immediately gives $f = (g\circ [\blank]_0)$.
  We leave the proof that the above type is contractible as an exercise.
\end{proof}

\begin{xca}\label{xca:||XhG||0-is-X/G}
Complete the details of the proof above. Given an identification of
