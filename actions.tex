...
set truncation of $X_{hG}$, see \cref{lem:X/G=setTruncX_hGs})
...
%\footnote{\MB{New:}%Here we use the uncurried form of $\Sub_G(X)$ as explained in \cref{ft:SubTotX}.}
...
%$G\cdot x =_{\Sub(X(\sh_G))} G\cdot y$;\quad
