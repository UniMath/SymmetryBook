...
\wip{Here?} We will have the occasion to use the following result which essentially 
...
when $\USymf$ is injective. The notions of monomorphism and
epimorphism will be generalized in \cref{def:mono-in-cat}
and \cref{def:epi-in-cat}, respectively.}
