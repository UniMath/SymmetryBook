...
that is, we need to provide a pointed equivalence
\[
  \varphi : \conncomp\Bicyc{\zet\amalg\zet,a,b} \ptdweto \sum_{S:\BSG_2}\B\tilde\CG_0(S),
\]
where $\B\tilde\CG_0 : \BSG_2 \to \UUp$ is the classifying type level version of
the above action of $\SG_2$ on the infinite cyclic group.
