...
\input group
\chapter{Symmetry}
\section{Cayley diagram, G ≃ Aut(Cayley-diagram G) → Sym(Card G)}
\section{orbit-stabilizer theorem}
\section{(the lemma that is not) Burnside's lemma}
\chapter{Finite group theory (optional?)}
...
\section{5-gon and the icosahedron (cyclotomic field of deg 5 has galois group (Z/5Z)* ≃ Z/4Z)}
