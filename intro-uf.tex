...
$T(x)$ could be $\NN\to S(x)$. Then $f:T(x)$ specifies a sequence
of elements of $S(x)$, and $\trp^T e\,f : T(y)$, specifies a sequence
of elements of $S(y)$. We see that the structure `sequence of elements'
