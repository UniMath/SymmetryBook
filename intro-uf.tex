...
\begin{lemma}\label{lem:transport-in-fx=Ygx}
...
\begin{xca}\label{xca:transport-in-a/x=b/x}
Prove the following special cases of \cref{lem:transport-in-fx=Ygx},
...
There is also a dependent version of \cref{lem:transport-in-fx=Ygx},
which can be proved by an additional induction on $i$.

\begin{lemma}\label{lem:transport-in-fx=Yxgx}
...
\label{sec:typefam}
There is a close relationship between maps and type families
...
$$ 
given by $\mathrm{preim}(B,f)(a)\defeq f^{-1}(a)$ is an equivalence.
