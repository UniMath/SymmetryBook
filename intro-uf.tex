...
\item If $X$ and $Y$ are connected, then $f$ is an equivalence if and only if each $\ap{f}$ is an equivalence;
\item If $X$ and $Y$ are connected, then all fibers of $f$ are sets if and only if each $\ap{f}$ is an injection.
\end{enumerate}
\end{corollary}
\begin{proof}
