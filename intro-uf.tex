...
and denoted by $X\to_*Y$. In the notation above
\[(X\to_*Y)\quad\jdeq\quad\sum_{f:X_\div\to Y_\div}\pt_{Y}=f(\pt_X).\]
\end{definition}
...
We may also tacitly coerce $f:X\to_*Y$ to $f:X_\div \to Y_\div$.
