...
$b$ of type $X$ and for any $e$ of type $a=b$, for use in rule E3 above.  This reduces us to the case where $b$ is $a$ and $p$ is $\refl a$, and
...
\begin{definition}\label{def:pathover-transport}
