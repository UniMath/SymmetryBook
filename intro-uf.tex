...
An important example of a contactible type in the
...
take as center the element $(a,\refl{a})$. TBE
...
$X = Y$ stipulated by $f$ (there could be other identifications as well).
