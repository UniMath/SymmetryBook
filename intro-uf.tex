...
$X$ and $Y$ are \emph{equivalent}, and we express that by writing $X\equiv Y$.
More precisely, we define the type of equivalences from $X$ to $Y$ by
\[
  (X\equiv Y) \defeq \sum_{f:X\to Y} \isEq(f).
\]
We remark that there could be more than one equivalence between $X$ and $Y$.
