...
\section{Some important subuniverses}\label{sec:subuniverses}
...
$(\sum_{a:A}P(a), \fst)$.
Equivalence now follows by \cref{lem:equivalence-via-inverse}.
\end{lemma}

\begin{proof}
We apply \cref{lem:equivalence-via-inverse}, and verify the two conditions.
...
The above argument can be elaborated for each of the subuniverses
