...
\begin{proof}
  ...
  The key point is that $\im(f)$ is a proposition: Suppose
  $(y_1,z_1),(y_2,z_2):\im(f)$. Since $B$ is a set, the type $y_1=_B
  y_2$ is a proposition. Hence we may hypothesize $x_1,x_2:A$ with
  $f\,x_i\jdeq y_i$ for $i=1,2$. By concatenation, we get
