...
\false)$ is a proposition whenever $P$ is a proproposition.  
...
call $P$ a \emph{predicate} on $T$.\index{predicate}
The \emph{subtype} of $T$ characterized by $P$ is defined
as $T_P\defeq \sum_{t:T} P(t)$.\footnote{%
  Technically, the subtype is the pair of the type
  $T_P$ together with the inclusion $\fst : T_P \to T$.}
