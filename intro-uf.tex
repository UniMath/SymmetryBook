...
\begin{enumerate}[label=(E\arabic*),ref=(E\arabic*)]\label{rules-for-equality}
  ...
  \item\label{E4} suppose we are given:
    \begin{enumerate}
    \item a type $X$ and an element $a:X$;
    \item a sequence of variables $b,e,s_1:S_1,\dots,s_n:S_n$ consisting of a variable $b$ of type $X$, a variable $e$ of type $a =_X b$, and perhaps some
      further variables; and
    \item a family of types $Y$ parametrized by variables $$s_1:S_1(a,\refl a),\dots,s_n:S_n(a,\refl a).$$
    \end{enumerate}
    Then from those data we are provided with a family of types $Z$ parametrized by the variables $b,e,s_1:S_1,\dots,s_n:S_n$.
