...
Here's an example of a family of types: we let $n$ be a natural number (larger than $2$) and $T$ be the type of $n$-sided polygons in the plane.  It gives a family
...
Here's an example of a family of elements in a (non-constant) family of types: we let $n$ be a natural number (larger than $2$) and $T$ be the
type of $n$-sided polygons in the Euclidean plane, as we did above.  Then we consider the regular $n$-sided polygon $e$ of radius $1$ with a
vertex on the $x$-axis.  One of the members of the family is the regular pentagon $e(5)$ of radius $1$ with a vertex on the $x$-axis.
...
function $T(a) \to T(b)$ provides a way to establish a claim about $b$
