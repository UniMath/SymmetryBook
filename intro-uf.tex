...
In a similar way we can define inductively, for any $n:\NN$,
an inductive type $\bn{n}$ of $n$ elements. For convenience
we sometimes denote these elements $0,1,\ldots,n-1$. 
Thus $\bn{0}\defeq\false$, 
and $\bn{1}\defeq\true$,
and $\bn{2}\defeq\bool$ with elements $\no\jdeq 0$ and $\yes\jdeq 1$.
...
%For simplicity we will refer to $\fin(n)$ as $\bn{n} $.  
  \begin{enumerate}
