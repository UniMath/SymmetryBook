...
(1) Let $A$ be a connected type, and suppose for every $a:A$ that $a=a$ is a proposition. 
Show that $A$ is contractible. (2) Show that any connected set is contractible.
\end{xca}
