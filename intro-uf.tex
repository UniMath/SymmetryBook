...
\begin{lemma}\label{lem:isEq-pair=}
  ...
  there is an equivalence $$\left ( (x,y) = (x',y') \right ) \weq \sum_{p:x=x'} \pathoverdisplay y Y p {y'}.$$
\end{lemma}
...
The lemma above will be applied mostly in the case where $x'$ and $x''$ are $x$.
