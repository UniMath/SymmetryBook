...
we set $g_{0,0}(\_)=\refl{0}$. In the two cases $0,S(\_)$, $S(\_),0$
for $n,m$ we have $\Eq_\NN(n,m)=\bn{0}$ 
...
that is, the fiber $f_{n,m}^{-1}(x)$ is contractible for all $x:\Eq_\NN(n,m)$.
