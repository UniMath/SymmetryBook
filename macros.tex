...
\let\openbox\relax
\usepackage[russian,main=english,shorthands=off]{babel}
...
\declaretheorem[sibling=theorem,style=cas-thm]{goal}
...
\def\construction{\proof[Construction]}
\def\endconstruction{\endproof}
%\newenvironment{\construction}[1][Construction]{\proof[#1]}{\endproof}
...
\renewcommand*{\sh}{\constant{sh}} % the basepoint of the classifying type of a group G, referred to as the designated shape of G
