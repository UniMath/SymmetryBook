...
\usepackage{mathabx} % for \circlearrowright
...
\newcommand{\Zloop}{\circlearrowright} %was \mathrm{loop}}%MAB: loop TorZor
\newcommand{\Sloop}{\circlearrowright}%loop in circle
...
\newcommand{\pathoverdisplay}[4]{#1 \underset{#3}= #4}
\newcommand{\pathover}[4]{#1 =_{#3} #4}
