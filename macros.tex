...
\newcommand*{\p}{\constant{sh}} % the basepoint of the classifying type of a group G, referred to as the designated shape of G
...
\newcommand*{\USym}{\casop{\constant{U}}} % underlying symmetries
...
\newcommand*{\clf}{\casop{B}} % classifying space operator (adds space)
\newcommand*{\B}{B}            % without extra space
\newcommand*{\BB}{\B^2}
...
\newcommand*{\isfinset}{\mathrm{isFinSet}}
