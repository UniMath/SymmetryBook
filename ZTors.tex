...
\sum_{a':A} X\to a=a'               \&       \&  A  \\
\\
\text{Recursion}\quad\quad\quad     \& \TorZ \&      \\};
...
\end{tikzpicture}
\caption{\label{fig:TorZ-rec-and-ind}Recursion, $X:\TorZ,\, a:A,\, p:a=a$}
\end{figure}
...
\end{tikzpicture}
\caption{\label{fig:TorZ-rec-and-ind}Induction, $X:\TorZ,\, a:A(\pt),\, p:a=^A_{\Zloop} a$}
\end{figure}
