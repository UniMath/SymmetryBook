...
\begin{lemma}\label{lem:concat-over}
  ...
  is an equivalence.
\end{lemma}
The proof is by induction on first $p_1$, and then on $q$.
The remaining proof obligation is resolved by an easy equivalence
correcting for $p_2 = \refl{a_1}\ct p_2$.
