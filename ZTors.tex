...
It would be interesting to see if and how our method can be generalised
from $\TorZ$ to the type of $G$-torsors where $G$ is any free group with
a decidable set of generators.
