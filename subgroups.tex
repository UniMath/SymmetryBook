...
With the choice of point of $\Img f$ above, give pointing paths for
${x\mapsto(\Bf(x),\trunc{(x, \refl {\Bf(x)})}_0)}$ and ${\fst}$
so that their composition is indeed equal to the pointed map $\Bf$.
Show that these maps indeed give an epimorphism and a monomorphism, respectively.
\end{xca}
