...
\begin{xca}\footnote{proofread}
  \marginnote{$$\xymatrix{\ker F_2\ar[r]^\cong\ar[d]^{F_1}&\ker f_1\ar[d]^{\ker_{f_1}}\\
  ...
  Furthermore, $$F_1=_{\typemono_{G_1}}\ker F_2$$ and $$(\coker f_1)\,\ker_{f_2}=_{\Ker f_2\to\Set}\coker (F_2).$$ 
\end{xca}
