...
$$\xymatrix{&\Img f_2f_1\ar[dr]^{\incl_{\img f_2f_1}}\ar@{.>}[dd]^t&\\
  ...
  &G_1\ar[ur]_{f_2}&}
$$}
then there is a unique isomorphism $t:\Hom(\Img f_2,f_1,G_1)$ such that $f_1=t\,\prj_{\img f_2f_1}$ and $f_2\,t=\incl_{\img f_2f_1}$.  Through univalence $t$ gives rise to identifications
...
\begin{implementation}{con:im}
  ...
  The homomorphism \marginnote{\color{blue}(which we must show is an epimorphism)}
