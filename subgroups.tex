...
\begin{definition}
 ...
 We define a function
  ...
  The classifying space of the \emph{kernel group}\index{kernel!group}
...
$\B \Ker f$ (or most often just the ``kernel'')is the pointed component of the fiber of $Bf$ containing 
