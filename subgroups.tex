...
That the image gives a \emph{unique factorization} is elegantly expressed by saying that it is the unique inverse of composition, or more precisely
  ...
  \begin{construction}\label{con:im}
    ...
    $$\circ((Z,p,!),(Z',j,!),\alpha)\defequi j\ua(\alpha) p$$
