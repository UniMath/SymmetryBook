...
and they happen to be connected, so classifying subgroups, respectively. 
In this case $F_1$ (pointed by reflexivity) is a homomorphism,
and $F_1^{\abstr}$ maps TBD.%$\Sloop^{2k}$ to $(0 1 2 3)^{2k} = ((0 2)(1 3))^k$.
...
\end{example}
The example above is not as general as possible since all fibers are
connected. See the following exercise for a more general case.
...
\begin{corollary}
  ...
  and a unique homomorphism $F_1$ from $\Ker(f_2f_1)$ to $\Ker(f_2)  $ such that $\kermap{f_1}\eqto \kermap{f_2f_1}F_2$ and $f_1\kermap{f_2f_1}\eqto \kermap{f_2}F_1$.
  Furthermore, $$F_2\eqto _{\typemono(G_1)}\kermap{f_2}$$ and $$(\coker(f_1) )\,\B\kermap{f_2}\eqto _{\B\Ker(f_2)  \to\Set}\coker (F_1).$$
  ...
  \end{enumerate}
Likewise, the set truncations $F'_1$ and $F'_2$ of the maps $F_2$ and $F_1$ constructed in \cref{lem:fibersofcomposites} give maps of $G_1$- and $G_2$-sets,\footnote{%
