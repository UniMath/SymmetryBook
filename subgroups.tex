...
The kernel will correspond to a preferred component of the preimage of $\sh_{G'}$, the cokernel will be the ($G'$-)set of components and for the image we will choose a component of the \covering corresponding to the cokernel.  This point of view makes it clear that the image will be a subgroup of $G'$, the kernel will be a subgroup of $G$, whereas there is no particular reason for the cokernel to be more than a ($G'$-) set.
...
The factorization of $f:\Hom(G,G')$ through its image is universal
\marginnote{$$\xymatrix{&G_1\ar[dr]^{f_2}\ar@{.>}[dd]^t&\\
    G_0\ar[ur]^{f_1}\ar[dr]_{\prj_{\img f_2f_1}}&&G_2\\
  &\Img f_2f_1\ar[ur]_{\incl_{\img f_2f_1}}}
$$}
in the sense that if given two homomorphisms $f_1:\Hom(G_0,G_1)$ and $f_2:\Hom(G_1,G_2)$ such that $f_1$ is an epimorphism and $f_2$ in a monomorphism, then there is a unique isomorphism $t:\Hom(G_1,\Img f_2,f_1)$ such that $t\,f_1=\prj_{\img f_2f_1}$ and $f_2=\incl_{\img f_2f_1}t$ and $t$ is an isomorphism.  Through univalence $t$ gives rise to identifications
...
\begin{implementation}{con:im}
  ...
  The homomorphism \marginnote{\color{blue}(which we must show is an epimorphism  - should also include the universal property of the factorization)} $\prj_{\Img f}:\Hom(G,\Img f)$  is given on the level of classifying types by sending $x:\BG$ to
  ...
  As for the universality of the factorization, assume given $f_1\Hom(G_0,G_1)$ and $f_2:\Hom(G_1,G_2)$ such that $f_1$ is an epimorphism and $f_2$ in a monomorphism.  Since  $\incl_{\img f_2f_1}$ is a monomorphism, there is at most one homomorphism $t:\Hom(G_1,\Img f_2,f_1)$ such that $f_2=\incl_{\img f_2f_1}t$.  We must show that such a $t$ exist and that it furthermore satisfies  $t\,f_1=\prj_{\img f_2f_1}$.  This is achieved by setting
