...
\marginnote{
  $$\xymatrix{G_0\ar@{=}[rr]&&G_0\\
    \Img f_1\ar@{=}[r]&\Img f_1&\\
    G_1&\Img(\prj_{\img f_2}\incl_{\img f_1})\ar@{=}[r]&\Img(f_2f_1)\\
    \Img f_2\ar@{=}[r]&\Img f_2&\\
    G_2\ar@{=}[rr]&&G_2
  }$$}
\begin{lemma}
  ...
  \prj_{\img(\prj_{\img f_2}\incl_{\img f_1})}\prj_{\img f_1},!)\\%\prj^{\img}(\prj_{\img f_2}\prj_{\img f_1})\\
    \img(f_2f_1)&=_{\typemono_{G_2}}%\img(\incl_{\img f_2}\incl_{\img (\prj_{\img f_2})\incl_{\img f_1})
  \end{align*}
