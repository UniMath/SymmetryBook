...
\begin{definition}
  ...
  $$E:\typemono_G\to\typesubgroup_G\qquad (H,i,!)\mapsto E(H,i,!)\defequi ((Bi)^{-1},(\shape_H,p_i),!),$$\glossary(E){$E$}{equivalence from $\typemono_G$ to $\typesubgroup_G$}
...
In \cref{ex:Cm} we studied a homomorphism from $\ZZ$ to $\Sigma_m$ defined via the pointed map $cy_m:S^1\to_*\BSG_m$ given by sending $\base$ to $\bn m$ and
