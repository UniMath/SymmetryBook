...
\begin{proof}
  ...
  In the general case, consider a surjection $p : Y \to X$,
...
[TODO: Think about whether the proof generalizes. Can we say something more if we assume trivial cohomology with coefficients in \inftygps?]
