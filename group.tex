...
\begin{proof}
  ...
  and (by induction on $n$) that each set $P(e)$ is $\set{0,1}$
  (our favorite $2$-element set).
  Then any function is equivalent to either the all $0$-function
  or the function that is $1$ at $1$ and $0$ otherwise,
