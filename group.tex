...
\end{definition}
\begin{remark}
  \label{remark:groupsasunivalenttype}By univalence, casting identitifications as equivalences gives an equivalence
  $$(G=_\typegroup G')\we \Iso(G,G'),$$
  and we continue using the notation $\ptoe p$ from \cref{def:idtoeq} for the equivalence corresponding to the identity $p:G=G'$.
\end{remark}
