...
\begin{definition}\label{def:group-symmetries}% or elements
  ...
  they are the symmetries of the designated shape $\p_G$ of $G$.
...
\begin{remark}
  ...
  an identification $G = \Aut_{\BG}(\p_G)$, of $G$ with the automorphism
  group of the designated shape $\p_G : \BG$.
\end{remark}
...
\begin{definition}\label{def:grouphomomorphism}
  ...
  and we call $\Bf$ is \emph{classifying map} of the homomorphism.
\end{definition}
...
$\ev_{\pt_G} : (\BG_\div=\BG_\div) \to \BG_\div$ defined by
$\ev_{\pt_G}(\varphi)\defequi \varphi(\pt_G)$. In particular,
$\ev_{\pt_G}(\id_{\BG_\div}) \jdeq \pt_G$. It makes the restriction
...
\begin{equation}
  \left( \id_{\BG_\div} = \id_{\BG_\div} \right) \weq \sum_{g:\pt_G=\pt_G}\prod_{h:\pt_G=\pt_G}gh=hg
\end{equation}
In yet other words,
