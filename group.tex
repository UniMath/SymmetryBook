...
$$B_n\defequi(\sum_{S:\fin_n}\Trunc{cy_n^{-1}(S)}_0,\trunc{(\base,\refl{\bn n})}_0)$$
...
It is good to know that $B_n$ is connected, so that $(B_n,\pt_{C_n})$ is actually 
the classifying type $BC_n$. Remember that 
