...
These properties of the identity type are bundled together in the concept of a group, under the additional hypothesis that we are dealing with a set.
  ...
  \begin{definition}
    A {\em group} is a set $G$ together with
\begin{enumerate}
\item an element $e:G$, 
...
\end{enumerate} 
  ...
  \begin{lemma}
    If $A$ is a type of level at most 3 (see \refer) and $a:A$ is an element, then $a+_Aa$, together with $e=\refl(a)$, $g^{-1}=\symm_{a,a}g$ and $g\cdot h=\trans_{a,a,a}(g)(h)$ define a group.
  \end{lemma}
  \begin{proof}
    The elements $p_1,\dots p_6$ show that all the relevant identity types (which are sets since $A$ is of type at most $3$) are inhabited as required.
  \end{proof}
