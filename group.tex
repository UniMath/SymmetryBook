...
$$
commutes, where the top composite is the image factorization of the kernel and the bottom incluison is the inclusion of fixed points.
\end{lemma}
\begin{proof}
