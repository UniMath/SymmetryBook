...
\item\label{it:mod_m}
  ...
  classifies a homomorphism $\ZZ \to \SG_m$. \wip{This homomorphism
  factors through $\CG_m$ (and, equivalently, through $\ZZ/m\ZZ$)
  ...
  The homomorphism $\CG_m \to \SG_m$ just forgets the
  cyclic structure.}\qedhere
  \end{enumerate}
\end{example}
