...
\end{remark}
((to do it as suggested in the remark we're going to need the following since it is going to reduce the burden of showing that $S^1$ is equivalent to the alternative model unto showing that it induces an equivalence $\zet\to\zet$.  Move it somewhere
