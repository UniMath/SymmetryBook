...
Since $\fin_n$ is a groupoid, $B_n$ is a groupoid. Remember that $cy_n^{-1}(S)\defequi\sum_{z:S^1}S=cy_nz$, and the map 
$$e:\sum_{S:\fin_n}cy_n^{-1}(S)\to S^1,\qquad e(S,z,p)=z$$ is an equivalence fitting into a commuting diagram
$$\xymatrix{
