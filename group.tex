...
\begin{definition}\label{def:sign-ordering}
  ...
  is an element of the set $\prod_{e:E(A)}P(e)/\sim$,
  ...
  of a finite set $A$ is an element of the quotient
  $\bigl(\prod_{e:E(A)}P(e)\bigr)/\sim$ of the set of local orderings
