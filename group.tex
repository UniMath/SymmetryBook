...
\begin{definition}\label{def:typegroup}
  ...
  \[
    \typegroup \defequi \sum_{A:\UU}\sum_{a:A} \isset(a=_Aa)
    \times \prod_{x:A}\Trunc{x=_Aa}
  \]
  of pointed connected groupoids.
  A group $G=(A,a,p,q):\typegroup$ will be referred to simply as
  \[
    \aut_A(a).
  \]
  ...
  The element $\pt_G\defequi a$ will be referred to as the \emph{base point}.
