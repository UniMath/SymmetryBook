...
\begin{xca}
  Construct an equivalence $\FG_{\bn n \coprod \true} \equivto \FG_{\bn n}
...
\begin{definition}\label{def:gensgp}
...
\begin{lemma}
  ...
  \[
    \rho : \BG \to \sum_{X:\UU}(S \to X \to X) ,
    \quad
    \rho(t) \defeq \bigl(t \eqto \sh_G, s \mapsto \iota(s) \cdot \blank\bigr)
  \]
...
\end{lemma}
In this case, then, $G$ can be identified with the automorphism group of $\rho(\sh_G)$.
\begin{proof}
