...
$(pq)_\pt \jdeq (\ptoe p(\sh_H)\cdot\blank)(q_\pt)\cdot p_\pt$,
...
so $(\ptoe p(\sh_H)\cdot\blank)(q_\pt): \ptoe p(\sh_H) \eqto 
...
type $\base\eqto\base$ as follows:
\[
...
\]
\begin{align*}
\ptw\Bigl(\inv p_\pt \cdot (\ptoe p(\sh_H)\cdot\blank)(\inv{q_\pt})\Bigr)(\base)
...
\ptw\Bigl((\ptoe p(\sh_H)\cdot\blank)(q_\pt)\cdot p_\pt\Bigr)(\base) 
