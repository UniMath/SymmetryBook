...
\begin{proof}
  ...
  \begin{displaymath}
    ...
    \end{tikzcd}
  \end{displaymath}
  Note that the dependent codomain of $\chi$ is always a set (as $A$ is a
  groupoid). Hence, defining $\chi$ on the connected domain $\Cyc_n$ can be
  done by just defining its image at $\pt_n$: we choose $\chi(\pt_n) \defequi
  p'\inv p$ in order to satisfy the requirement.
\end{proof}
