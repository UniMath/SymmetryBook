...
Hint: use \cref{xca:C2} and \cref{lem:freeloopspace}.
\end{enumerate}
\end{xca}
...
\begin{tikzcd}
  ...
  X_P \ar[r,"g"] \ar[u,"\fst"]     & Y_Q \ar[u,"\fst"']
\end{tikzcd}
\]
In case $S$ is given by a predicate $P: X\to\Prop$
and $S$ is given by a predicate $Q: Y\to\Prop$, 
\end{remark}
