...
The Limited Principle of Omniscience is weaker than the Law of Excluded Middle \cref{pri:lem}, as we prove in the following lemma.\footnote{%
  ...
  Here we give an example of a weak counterexample based on the famous Goldbach conjecture,
  ...
  or $\inl{l}$ for some element $l:L$. If $t(P)\defeq\inr{r}$ the Goldbach conjecture is true, 
  and if $t(P)\defeq\inl{l}$ the Goldbach conjecture is false. Thus the Goldbach conjecture
