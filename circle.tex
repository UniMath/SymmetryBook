...
as an equivalence. Moreover, 
the proof of $-^m = -^m \id_\Sc$ is only given as ${\Sloop}^k : \base=\base$; 
the proof of stability of ${\Sloop}^k$ under $\Sloop$ has been left out;
various equivalences pertaining to function extensionality, the
universal property of the circle, and paths in $\sum$-types, have been waived.)
...
Hint: use \cref{xca:S1=S1-components}.
\end{xca}
