...
so me make the following definitions to make it easier to talk about them.
...
\end{definition}
We have a canonical injection $\NN \to \Order$,
...
\begin{theorem}\label{thm:fiber-cdg}
  ...
  where $P\defeq (H_t \subseteq m\zet)$ expresses that $m$ divides the order of $t$.
\end{theorem}
\begin{proof}
