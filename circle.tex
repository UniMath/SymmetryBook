...
\begin{principle}
  ...
  Any function $P:\NN\to\bn 2$ is either constant (we have that $\prod_{n:\NN}(P(0)=P(n))$),
  or there is a smallest $n_0:\NN$ such that $P(n_0)\neq P(0)$.
\end{principle}
...
Since $f$ is a decidable \covering exactly, we have that the preimages $g^{-1}(m)$
