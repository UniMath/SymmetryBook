...
\\
     &P(b)\ar[uuu,"{y\mapsto(b,y)}"]\ar[rr]&&\ar[uuu,"b"]\bn{1}\\
      \sum\limits_{y:P(b)} Q(b,y) \ar[r,"\trunc{\blank}_n"'] \ar [ur,"\fst"]\ar[uuu,"{z\mapsto(b,z)}"]& 
      \Trunc{\sum\limits_{y:P(b)} Q(b,y)}_n \ar[r,"E.\,\ref{xca:pullout-base-type}"'] & 
      \sum\limits_{y:P(b)} \Trunc{Q(b,y)}_n \ar[ur]\ar[uuu,"{z'\mapsto(b,z')}"]\\
    \end{tikzcd}
  \]
