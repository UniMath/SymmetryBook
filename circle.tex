...
is an equivalence. (Compare the latter type to
$(\Sc\to A)\to \sum_{a:A}(a\eqto a)$ in \cref{lem:freeloopspace}
and see \cref{fig:circle-induction}.)
\end{remark}
...
From addition and ${-}: \zet\to\zet$ one can define a
\emph{subtraction} function setting $z-y \defeq z+(-y)$.
\glossary(subtraction){${-}$}{subtraction of integers}
