...
$p$ is $n$-connected.\footnote{For $T:B\to\UU$ and $f$ a map sending
$(b,t):\sum_{b:B}T(b)$ to $(b,\trunc{t}_n)$, the fibers of $f$ at
$(b,t'):\sum_{b:B}\Trunc{T(b)}_n$ are equivalent to the
