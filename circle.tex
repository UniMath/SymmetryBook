...
transport along $p:a\eqto a'$ of $h:P(a)\to Q(a)$ is
...
$(\zs^n,p) : (\zet,\zs)=(\zet,\zs)$, where $p$ is a proof of
$\zs^n \zs = \zs \zs^n$.
...
consider $\zs^n$ as an element of the set $(\zet,\zs)\eqto(\zet,\zs)$.
Note that we did already coerce $\etop\zs$ to $\zs$ here. 
\end{remark}
