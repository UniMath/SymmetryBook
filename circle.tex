...
$P_\base$ defines a connected covering of the circle: $P_\base(z)\defequi (\base=z)$ is a set for all $z:S^1$ and the type $P_\base S^1$ is connected (more precisely, by univalence $P_\base(z)=R(z)\defequi\zet$ and $P_\base S^1$ is contractible).
\end{lemma}
\begin{proof}
