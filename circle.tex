...
The inverse equivalence of $g(\base)\jdeq{\Sloop}^{\blank}
...
\begin{xca}\label{xca:general-winding}
  ...
  an equivalence, $\wdg_x : (x \eqto x) \we \zet$.
...
namely the set $\zet$ of integers together with the successor $\zs: \zet\equivto\zet$. By \cref{kfjgh},
