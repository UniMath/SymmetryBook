...
in $A$ straight above $b$,bso that in this case each preimage contains 
...
In this exercise we further elaborate the difference between $A$ and 
$A'$ above. Let $c_\bool \defeq (z\mapsto\bool): \Sc\to\Set$.
