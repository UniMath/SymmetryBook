...
is the identity on $\zet$. This follows from the definition of 
$\ap{c}(\Sloop) = \pathpair{\etop{s}}{!}$ and induction on $n:\zet$
proving  $\ev_0(\ap{c}(\Sloop^n))=\ev_0(\pathpair{\etop{s}^n}{!}) = s^n(0) = n$. 
