...
\begin{proof}
Let $m>0$ and recall $D_m\defequi\sum_{t:\Sc\equiv\Sc} -^m =_{\Sc\to \Sc} -^m t$.
Define 
\[
...
as an equivalence. Moreover, the proof of $-^m = -^m \id_\Sc$ is only given
as ${\Sloop}^k : \base=\base$;
stability of ${\Sloop}^k$ under $\Sloop$ is a true proposition that has been left out.)
