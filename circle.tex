...
We should notice that the notion of a \covering is just one step up from the notion of an injection (a function such that all the preimages are propositions).
