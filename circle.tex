...
rely on the notion of proposition: all fibers of $p$ are non-empty
...
%\begin{definition}\label{def:n-image-factorization}
 % Let $A,B$ be types and let $f : A \to B$. 
  ...
  \]
%\end{definition}
Clearly, $i$ is $n$-truncated. TODO $p$ is $n$-connected and
...
and we have the following commutative diagram:
  \[
    ...
    \end{tikzcd}
  \]
Then we have $\inv {(h\circ g)} (b) = \sum_{y:\inv h (b)} \inv {\tilde{g}}(b,y)$
for all $b:B$.
\end{construction}
