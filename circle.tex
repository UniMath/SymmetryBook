...
({\color{red} I think $\sqrt[m]s$ should twice be $(\sqrt[m]s)^m$, and that the cicle induction requires that $\mZ$ is invariant under $\Sloop$. That appears to be the same
...
\begin{xca}
Check the implicit claims in \cref{exa:mfoldCcover}.
((perhaps best to make them explicit?)) {\color{red} What about: 
