...
If $(A,a)$ and $(A',a')$ are pointed types,  \emph{pointed function} from  $(A,a)$ to $(A',a')$ is a function $f:A\to A'$ together with an element $p:f(a)=a'$.  In other words, the \emph{type of pointed functions} from a pointed type $B$ to another $B'$ is
