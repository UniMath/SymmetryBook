...
\subsection{Deck transformations of the circle are ``cyclic'' }
\label{sec:deckS1}

In this subsection we prove the following result.  In the heading the term ``cyclic'' refers to the fact that we show that the deck transformations are determined by iterations of a single symmetry.  
