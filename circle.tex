...
$\sum_{g:S\to T} (f\circ i_1 = i_2\circ g)$ is a proposition.
\[
\begin{tikzcd}
  X \ar[r,"f"]  & Y &&  
  X \ar[r,"f"]  & Y                          \\
  S \ar[r,"g"] \ar[u,"i_1"]        & T \ar[u,"i_2"'] &&
  X_P \ar[r,dashed] \ar[u,"\fst"]     & Y_Q \ar[u,"\fst"']
\end{tikzcd}
\]
...
Now we have $\prod_{x:X}(P(x)\to Q(f(x))$ if and only if the type
$\sum_{g:X_P\to Y_Q} (f\circ \fst = \fst\circ g)$ is contractible.

For a proof of the latter logical equivalence, assume
$p: \prod_{x:X}(P(x)\to Q(f(x))$ and define $g$ by
%$(z:X_P) \mapsto (f(\fst(z)),p(fs
\end{remark}
