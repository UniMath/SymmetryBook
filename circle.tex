...
the recursion principle provides an element of $\ap{f}(\Sloop)=l$.
...
and that under this identification $0:\zet$ corresponds to 
$\refl{\base}:\base=\base$, $1:\zet$ corresponds to $\Sloop:\base=\base$,
and $-1:\zet$ corresponds to $\Sloop^{-1}:\base=\base$. More generally,
